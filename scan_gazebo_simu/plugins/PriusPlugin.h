...
#ifndef PRIUSCUP_PLUGINS_PRIUSPLUGIN_H_
#define PRIUSCUP_PLUGINS_PRIUSPLUGIN_H_
...
namespace gazebo {
  ...
  /// \brief A model plugin for prius 
  class PriusPlugin : public ModelPlugin {
    /// \brief Constructor.
    public: PriusPlugin();

    /// \brief Destructor.
    public: virtual ~PriusPlugin();
